//! IPC communication utilities for device manager
...
pub extern "C" fn sys_ipc_send(port_id: u64, msg: *const IpcMessage) -> i32 {
    // This will be linked to the actual syscall implementation
    // For now, it's a placeholder
    unsafe {
        syscall(9, port_id, msg as u64, 0, 0, 0) as i32
    }
}
...
pub extern "C" fn sys_ipc_receive(port_id: u64, msg: *mut IpcMessage) -> i32 {
    unsafe {
        syscall(10, port_id, msg as u64, 0, 0, 0) as i32
    }
}

/// Raw syscall function (architecture-specific)
#[cfg(target_arch = "x86_64")]
unsafe fn syscall(num: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) -> u64 {
    let ret: u64;
    core::arch::asm!(
        "syscall",
        in("rax") num,
